/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d92bbb81e719fb986b810da59d12c189)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OpenClawAgent" | "ChildAgent";
	}
	interface Env {
		...
		EXA_API_KEY: string;
		LOCAL_NOAUTH: string;
		OpenClawAgent: DurableObjectNamespace<import("./src/entry.worker").OpenClawAgent>;
