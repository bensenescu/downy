/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4adefc4f92834840a1538f91c0e42b64)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ChildAgent" | "DownyAgent";
	}
	interface Env {
		WORKSPACE_BUCKET: R2Bucket;
		DB: D1Database;
		LOADER: WorkerLoader;
		PI_RELAY_VPC: Fetcher;
		AI: Ai;
		...
		EXA_API_KEY: string;
		LOCAL_NOAUTH: string;
		DownyAgent: DurableObjectNamespace<import("./src/entry.worker").DownyAgent>;
		ChildAgent: DurableObjectNamespace<import("./src/entry.worker").ChildAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POLICY_AUD" | "TEAM_DOMAIN" | "MODEL_ID" | "EXA_API_KEY" | "LOCAL_NOAUTH">> {}
}
