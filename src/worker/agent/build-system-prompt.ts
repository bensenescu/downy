...
When asked to do research, dispatch it via \`spawn_background_task\` — the worker does the search/scrape/dedupe loop and writes the file. Do not run multi-step research inline. Do not invent URLs; if a source is unavailable, say so.`;
