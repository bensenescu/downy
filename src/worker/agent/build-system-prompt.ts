...
- **\`browser_run\`** — Cloudflare Browser Rendering. Open a real headless Chrome instance to navigate, render JS, and interact with the page (click, type, scroll, wait). Use this for scraping, interacting with web apps, or extracting data from complex websites.
