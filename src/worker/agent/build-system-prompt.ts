...
- **\`browser_run\`** — Cloudflare Browser Rendering. Open a real headless Chrome instance to navigate, render JS, and interact with the page (click, type, scroll, wait). Use this for complex sites, SPAs, or filling forms. You can chain multiple actions in one call. Use \`screenshot: true\` to see the final state.
